...
export const DUBAI_CONTENT: Record<Language, DubaiContent> = {
  en: {
    ...
    comparisonRows: [
      ...
      { label: "Used luxury market", dubai: "Very active", alemania: "Smaller offer", dubaiGood: true },
    ...
    popularModels: [
      ...
      { name: "Lamborghini Urus", emoji: "", note: "Potential savings" },
  ...
  es: {
    ...
    comparisonRows: [
      ...
      { label: "Mercado lujo 2ª mano", dubai: "Muy activo", alemania: "Menor oferta", dubaiGood: true },
    ...
    popularModels: [
      ...
      { name: "Lamborghini Urus", emoji: "", note: "Ahorro potencial" },
  ...
  ru: {
    ...
    comparisonRows: [
      ...
      { label: "Б/у премиум-сегмент", dubai: "Очень активен", alemania: "Меньше выбор", dubaiGood: true },
    ...
    popularModels: [
      ...
      { name: "Lamborghini Urus", emoji: "", note: "Возможная экономия" },
  ...
  de: {
    ...
    comparisonRows: [
      ...
      { label: "Luxus-Gebrauchtmarkt", dubai: "Sehr aktiv", alemania: "Kleineres Angebot", dubaiGood: true },
    ...
    popularModels: [
      ...
      { name: "Lamborghini Urus", emoji: "", note: "Sparpotenzial" },
  ...
  fr: {
    ...
    comparisonRows: [
      ...
      { label: "Luxe d'occasion", dubai: "Très actif", alemania: "Offre réduite", dubaiGood: true },
    ...
    popularModels: [
      ...
      { name: "Lamborghini Urus", emoji: "", note: "Économie possible" },
