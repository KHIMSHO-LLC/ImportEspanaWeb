    ...
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
            <div className="bg-blue-50 rounded-xl p-3 text-center">
              <Globe size={18} className="text-blue-600 mx-auto mb-1" />
            ...
            <div className="bg-green-50 rounded-xl p-3 text-center">
              ...
              <div className="text-xs text-gray-500">{t.transport}</div>
            </div>
            <div className="bg-purple-50 rounded-xl p-3 text-center">
              ...
              <div className="text-xs text-gray-500">{t.mostImported}</div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-6 pb-20">
        ...
        <section className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-center text-white">
          ...
          <Link
            href={`/?importType=${country.isEU ? "EU" : "NON_EU"}&originCountry=${country.name}`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            {otherCountries.map((c) => (
              <Link
                ...
                className="bg-white rounded-xl border border-gray-200 p-3 hover:border-blue-300 hover:shadow-sm transition-all flex items-center gap-2"
              >
