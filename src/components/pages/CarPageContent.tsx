  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-blue-50 rounded-xl p-4 text-center border border-blue-100">
              <Euro size={20} className="text-blue-600 mx-auto mb-2" />
            ...
            <div className="bg-green-50 rounded-xl p-4 text-center border border-green-100">
              ...
              <div className="text-xs text-gray-500 font-medium">Potencia</div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-8 pb-20">
        ...
        <section className="bg-white rounded-2xl shadow-sm p-4 md:p-6 border border-blue-100">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 flex items-center gap-2 mb-2 border-b pb-4">
